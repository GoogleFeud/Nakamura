...
const Structures = require("../structures/StructureGenerator.js");
        ...
        this._ws.on('message', msg => {
            ...
            switch (msg.op) {
                case GatewayOpcodes.DISPATCH:
                    ...
                    switch (msg.t) {
                        case 'READY':
                            this.client.user = new (Structures.get(this.client, "User"))(this.client, msg.d.user);
                        ...
                        case 'GUILD_CREATE':
                            ...
                            if (this._unavailableGuilds.has(msg.d.id)) {
                                this._unavailableGuilds.delete(msg.d.id);
                                    const g = new (Structures.get(this.client, "Guild"))(this.client, msg.d);
                                    this.emit("loadGuild", g)
                                ...
                                const g = new (Structures.get(this.client, "Guild"))(this.client, msg.d);
                                this.emit('guildJoin', g);
                            }
                            break

                        case 'MESSAGE_CREATE':
                            this.emit('messageCreate', new (Structures.get(this.client, "Message"))(this.client, msg.d));
                            break
