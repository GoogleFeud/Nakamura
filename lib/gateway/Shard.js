 ...
 * @property {Client} client - The [Client]{@link Client} object this shard belongs to 
 * @property {Number} shardId - The ID of the shard
 * 
 */
module.exports = class Shard {
    ...
    /**
     * Connects the shard to the ws server
     * @private
     */
    connect() {
...
*/
    ...
    /**
     * 
     * @param {Presence} o -  Sets the shard's presence
     */
    setPresence(o) {
